...
export default function Footer() {
  ...
  viewBox="0 0 24 24"
>
  <path d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.717h-3.233v12.45a2.896 2.896 0 1 1-2.896-2.896c.226 0 .447.026.66.075V8.307a6.13 6.13 0 0 0-.66-.035A6.13 6.13 0 1 0 15.82 14.4V8.077a8.01 8.01 0 0 0 4.769 1.579V6.686z" />
</svg>
              </a>
